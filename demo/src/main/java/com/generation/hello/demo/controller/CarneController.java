...
public class CarneController {
	...
	@RequestMapping(path = "/carne/new/{id}/{tipo}/{qtdEstoque}", method = RequestMethod.GET)
	public CarneService getCarne(@PathVariable int id, @PathVariable String tipo ,@PathVariable int qtdEstoque ) {
		CarneService service = new CarneService();
